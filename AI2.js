...
function handleFinalResult(className) {
  ...
  // —— ตรงนี้เป็นโค้ดที่เพิ่มขึ้น —— 
  // ซ่อนทั้งปุ่มวินิจฉัย (startButton) และปุ่มอัพโหลด/ถ่ายรูป
  startButton.style.display = 'none';                         // ปุ่มวินิจฉัยโรค
  document.getElementById('selectImage').style.display  = 'none'; // ปุ่มอัพโหลดรูปจากอัลบั้ม
  document.getElementById('captureImage').style.display = 'none'; // ปุ่มถ่ายภาพจากกล้อง
}
